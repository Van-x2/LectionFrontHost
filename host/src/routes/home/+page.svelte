    ...
    <div class="w-full h-[88%] flex-grow flex-col">
        <div class="w-full h-[50%] lg:h-[35%] flex justify-center items-center">
            <div class="w-full h-full px-6 pb-[2px] flex-col">
                <div class="w-full h-[20%] flex items-center pl-8 text-[30px] text-accent font-normal italic ">
                    <h1>Welcome back {$page.data.session?.user?.name}!</h1>
                </div>
                <div class="w-full h-[80%] flex">

                    <div class="h-full w-1/3 p-[18px]">
                        <div class="w-full h-full bg-gray1 rounded-[20px]">
        ...
        <div class="w-full h-[50%] lg:h-[65%] p-4 px-8 pb-[35px]">
            <div class="w-full h-full bg-gray1 rounded-[20px] max-h-[100%]">
                ...
                <div class=" w-full h-[74%]">
                    <div class=" text-[13px] w-full h-full pl-8 text-secondary font-poppins font-medium overflow-auto leading-[15px] max-h-[95%] scroll overflow-y-scroll">
                        <ol>
                            {#each list as item, i}
                                <li>{i+1} - {item}</li>
                                <br>
